...
;;(add-to-list 'load-path (concat user-emacs-directory "/site-lisp/ensime_2.10.0-RC3-0.9.8.2/elisp"))
(require 'ensime)
...
(set-face-underline-p  'ensime-errline-highlight "#ff0000")
(set-face-background   'ensime-warnline-highlight nil)
(set-face-underline-p  'ensime-warnline-highlight "#ffff00")
